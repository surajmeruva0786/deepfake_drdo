...
\subsection{Datasets}
Table~\ref{tab:datasets} summarizes both corpora and the protocol applied to each. Video is sampled at $T=32$ frames per clip; audio is resampled to 16~kHz and windowed into 1~s (16{,}000-sample) segments represented by 64 mel bins.
...
\toprule
 & \textbf{Celeb-DF-v2} \cite{li2020celebdf} & \textbf{FakeAVCeleb} \cite{khalid2021fakeavceleb} \\
\midrule
...
\bibitem{li2020celebdf} Y. Li, X. Yang, P. Sun, H. Qi, and S. Lyu, ``Celeb-DF: A large-scale challenging dataset for DeepFake forensics,'' in \emph{Proc. IEEE/CVF CVPR}, 2020, pp. 3207--3216.
