...
\item A \textbf{comprehensive evaluation suite} -- ROC/PR analysis, confusion matrices, t-SNE visualization, and Gaussian-noise robustness -- reported for PGCF, AGCF, and both fusion strategies.
\end{itemize}
