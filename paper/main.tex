...
\subsection{Datasets}
\textbf{Celeb-DF-v2} was used to train and validate the video branch, PGCF (Section~III-B), providing high-quality visual manipulations for spatial artifact learning.
